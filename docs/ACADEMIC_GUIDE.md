...
Do not interpret outputs as realized losses, probabilities, trade quantities, or company forecasts. See [Calculation specification](calculation/README.md), [Validation note](validation/MLE_VALIDATION.md), and [Model roadmap](MODEL_ROADMAP.md).
