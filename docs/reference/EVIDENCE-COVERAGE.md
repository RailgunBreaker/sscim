...
*Generated from the vault by `server/scripts/build-evidence-coverage.mjs`. Last generated: 2026-09-22.*
*Model version: `sscim-model-v7.1-exposure-robustness` · snapshot date: 2026-09-22 · canonical specification: [MODEL_V7_SPEC.md](../MODEL_V7_SPEC.md).*
