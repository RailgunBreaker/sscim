...
> does.** In particular, the following v6 constructs are gone:
>
> | v6 construct here | What replaced it in v7 |
> | --- | --- |
> | one global `halfLifeDays` for every event class | per-incident temporal profiles (`acuteHalfLifeDays`, `marketHalfLifeDays`, `outageRecoveryDays`, `persistent_policy`, `strategic_context`) |
...
> | a single HHI with the residual folded in | an explicit `[lower, upper]` interval |
> | `componentWeights` including an unread `shock` term | the v7 registry structural weights, with `shock` deleted |
>
> It is kept because the v6 numbers in `docs/benchmarks/v6-frozen-benchmark.json`
> were produced by exactly these formulas, and a frozen result with no
> readable definition behind it is not a record of anything.
...
Equations are rendered with LaTeX. Every heading below links into the document; use the contents to jump.
...
4. [Model Parameters and Their Current Role](#4-model-parameters-and-their-current-role)
5. [Data Normalization](#5-data-normalization)
6. [Event Decay](#6-event-decay)
7. [Calculating the Event Half-Life](#7-calculating-the-event-half-life)
8. [Substitutability and Effective Specificity](#8-substitutability-and-effective-specificity)
9. [Calculating the Specificity Floor](#9-calculating-the-specificity-floor)
10. [Downstream Shock Propagation](#10-downstream-shock-propagation)
11. [Calculating the Downstream Transmission Parameter](#11-calculating-the-downstream-transmission-parameter)
12. [Upstream Shock Propagation](#12-upstream-shock-propagation)
13. [Calculating the Upstream Transmission Parameter](#13-calculating-the-upstream-transmission-parameter)
14. [Combining Multiple Incoming Shocks](#14-combining-multiple-incoming-shocks)
15. [Multi-Step Network Propagation](#15-multi-step-network-propagation)
16. [Contribution Tolerance](#16-contribution-tolerance)
17. [Calculating the Contribution Tolerance](#17-calculating-the-contribution-tolerance)
18. [Network Importance](#18-network-importance)
19. [Geographic Risk](#19-geographic-risk)
20. [Policy Exposure](#20-policy-exposure)
21. [Calculating the Additional-Policy Factor](#21-calculating-the-additional-policy-factor)
22. [Substitutability Risk Score](#22-substitutability-risk-score)
23. [Market Dominance Score](#23-market-dominance-score)
24. [Current Shock Score](#24-current-shock-score)
25. [Structural Risk Score](#25-structural-risk-score)
26. [Structural Score Without Current Shock](#26-structural-score-without-current-shock)
27. [Calculating the Component Weights](#27-calculating-the-component-weights)
28. [Company Vulnerability](#28-company-vulnerability)
29. [Company Contribution to System Risk](#29-company-contribution-to-system-risk)
30. [Systemic Criticality](#30-systemic-criticality)
31. [Stage-Level Risk](#31-stage-level-risk)
32. [Country Risk](#32-country-risk)
33. [Shareholder Influence](#33-shareholder-influence)
34. [Overall Semiconductor Supply-Chain Index](#34-overall-semiconductor-supply-chain-index)
35. [Historical Trend Calculation](#35-historical-trend-calculation)
36. [Sensitivity Analysis](#36-sensitivity-analysis)
37. [Replacing the Fixed 30% Range with Statistical Uncertainty](#37-replacing-the-fixed-30-range-with-statistical-uncertainty)
38. [Dataset Snapshot Date](#38-dataset-snapshot-date)
39. [Full End-to-End Worked Example](#39-full-end-to-end-worked-example)
40. [Parameter Provenance: Where the Current Numbers Actually Came From](#40-parameter-provenance-where-the-current-numbers-actually-came-from)
41. [Calibration Framework](#41-calibration-framework)
42. [Historical Data Needed for Calibration](#42-historical-data-needed-for-calibration)
43. [Expected Outputs](#43-expected-outputs)
44. [Example Output Objects](#44-example-output-objects)
45. [What the Current Numbers Mean](#45-what-the-current-numbers-mean)
46. [Minimum Viable Product Data Requirements](#46-minimum-viable-product-data-requirements)
47. [Validation Tests](#47-validation-tests)
48. [Final Interpretation](#48-final-interpretation)
49. [One-Sentence Summary](#49-one-sentence-summary)
...
4. source confidence
5. shareholder data
6. ~~facility-level geolocation~~ — added: 275 named sites covering all 109 modeled companies, with coordinates, operator, output and stage mapping, plus a derived site-to-site link set. Location and identity only; capacity is still absent, and the site weight used for hazard exposure is a 1–5 analyst ordinal.
