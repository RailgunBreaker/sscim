...
>
> **Every number and formula below was produced by the superseded v6 engine.**
> It is preserved because `docs/benchmarks/v6-frozen-benchmark.json` holds the
...
> [`docs/computation-demo/COMPUTATION_DEMO.md`](../../computation-demo/COMPUTATION_DEMO.md).
>
> The CSV exports this document indexes were moved to
> [`docs/archive/v6/csv/`](csv/) alongside it, and the v6 machine-readable
> worked example to [`worked-example-v6.json`](worked-example-v6.json). They are
> v6 outputs and must not be read as current.
>
