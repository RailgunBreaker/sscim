...
| `sscim-app.html` | the dashboard — map, flow graph, topology, events, history review, hazard screening, watchlist, and a link to the canonical methodology document |
