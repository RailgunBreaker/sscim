...
const steps = [
  ...
  // Capture partial-run failures as well as successes for the pilot coverage audit.
  { id: 'pilot_intake', script: 'server/scripts/sync-pilot-intake.mjs' },
  ...
  { id: 'chain_loss_verification', script: 'server/scripts/evaluate-chain-loss-verification.mjs' },
  ...
  { id: 'operating_evidence', script: 'server/scripts/evaluate-gf-operating-evidence.mjs' },
