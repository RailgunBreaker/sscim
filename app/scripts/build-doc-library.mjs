...
const priority = ['docs/README.md', 'docs/PUBLIC_GUIDE.md', 'docs/METHODOLOGY.md', 'docs/calculation/README.md', 'docs/SYSTEM_ARCHITECTURE.md', 'docs/DATA_SOURCES_AND_OUTPUTS.md', 'docs/DEVELOPER_GUIDE.md', 'docs/ACADEMIC_GUIDE.md'];
const rank = (file) => {
