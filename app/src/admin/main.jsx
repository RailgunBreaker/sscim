...
function App() {
  ...
  const decide = async (action) => {
    ...
    try {
      ...
      setNote(result.published ? `Published: ${result.message}` : `Decision saved locally. ${result.error || 'Publication will retry.'}`);
      await load('queue');
