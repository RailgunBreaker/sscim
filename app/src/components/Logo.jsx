...
export default function Logo({ cid, size = 18 }) {
  ...
  return (
    <span style={{ width: size, height: size, borderRadius: 4, background: C.raised, border: `1px solid ${C.line}`, display: "inline-flex", alignItems: "center", justifyContent: "center", overflow: "hidden", flexShrink: 0, verticalAlign: "middle" }}>
      {d && !err
