...
export const I18N = {
  ...
  zh: {
    ...
    EVENTS: "事件", HISTORY: "历史", COMPANIES: "公司", "MOVERS 7D": "7日变动", CAPITAL: "资本",
    Help: "帮助", "Generate briefing": "生成简报", "ⓘ Methodology": "ⓘ 方法论", Documentation: "文档", "✦ Build scenario": "✦ 自建情景",
  ...
  tw: {
    ...
    EVENTS: "事件", HISTORY: "歷史", COMPANIES: "公司", "MOVERS 7D": "7日變動", CAPITAL: "資本",
    Help: "說明", "Generate briefing": "產生簡報", "ⓘ Methodology": "ⓘ 方法論", Documentation: "文件", "✦ Build scenario": "✦ 自建情境",
  ...
  ja: {
    ...
    EVENTS: "イベント", HISTORY: "履歴", COMPANIES: "企業", "MOVERS 7D": "7日変動", CAPITAL: "資本",
    Help: "ヘルプ", "Generate briefing": "ブリーフィングを作成", "ⓘ Methodology": "ⓘ 方法論", Documentation: "ドキュメント", "✦ Build scenario": "✦ シナリオ作成",
